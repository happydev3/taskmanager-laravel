                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('applicant') ? 'is-invalid' : '' }}" name="applicant_id" id="applicant_id" required>
                                @foreach($applicants as $id => $applicant)
                                    <option value="{{ $id }}" {{ ($task->applicant ? $task->applicant->id : old('applicant_id')) == $id ? 'selected' : '' }}>{{ $applicant }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('contact_person') ? 'is-invalid' : '' }}" type="text" name="contact_person" id="contact_person" value="{{ old('contact_person', $task->contact_person) }}">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('optional_email') ? 'is-invalid' : '' }}" type="email" name="optional_email" id="optional_email" value="{{ old('optional_email', $task->optional_email) }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Task::JOB_TYPE_RADIO as $key => $label)
                                <div class="form-check {{ $errors->has('job_type') ? 'is-invalid' : '' }}">
                                    <input class="form-check-input" type="radio" id="job_type_{{ $key }}" name="job_type" value="{{ $key }}" {{ old('job_type', $task->job_type) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            <div class="form-check {{ $errors->has('passed') ? 'is-invalid' : '' }}">
                                ...
                                <input class="form-check-input" type="checkbox" name="passed" id="passed" value="1" {{ $task->passed || old('passed', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="form-check {{ $errors->has('failed') ? 'is-invalid' : '' }}">
                                ...
                                <input class="form-check-input" type="checkbox" name="failed" id="failed" value="1" {{ $task->failed || old('failed', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="form-check {{ $errors->has('resurveyed') ? 'is-invalid' : '' }}">
                                ...
                                <input class="form-check-input" type="checkbox" name="resurveyed" id="resurveyed" value="1" {{ $task->resurveyed || old('resurveyed', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('lot') ? 'is-invalid' : '' }}" type="text" name="lot" id="lot" value="{{ old('lot', $task->lot) }}">
                                    @if($errors->has('lot'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('lot') }}
                                        </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('block') ? 'is-invalid' : '' }}" type="text" name="block" id="block" value="{{ old('block', $task->block) }}">
                                    @if($errors->has('block'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('block') }}
                                        </div>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('plan') ? 'is-invalid' : '' }}" type="text" name="plan" id="plan" value="{{ old('plan', $task->plan) }}">
                                    @if($errors->has('plan'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('plan') }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('houseno_unit') ? 'is-invalid' : '' }}" type="text" name="houseno_unit" id="houseno_unit" value="{{ old('houseno_unit', $task->houseno_unit) }}">
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('street') ? 'is-invalid' : '' }}" type="text" name="street" id="street" value="{{ old('street', $task->street) }}">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                                        @foreach($cities as $id => $city)
                                            <option value="{{ $id }}" {{ ($task->city ? $task->city->id : old('city_id')) == $id ? 'selected' : '' }}>{{ $city }}</option>
                                        @endforeach
                                    </select>
                                    @if($errors->has('city'))
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('subdivision') ? 'is-invalid' : '' }}" name="subdivision_id" id="subdivision_id">
                                        @foreach($subdivisions as $id => $subdivision)
                                            <option value="{{ $id }}" {{ ($task->subdivision ? $task->subdivision->id : old('subdivision_id')) == $id ? 'selected' : '' }}>{{ $subdivision }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('ascm') ? 'is-invalid' : '' }}" type="text" name="ascm" id="ascm" value="{{ old('ascm', $task->ascm) }}">
                                    @if($errors->has('ascm'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('ascm') }}
                                        </div>
                    ...
                    <div class="col-md-3"><div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('survey_by') ? 'is-invalid' : '' }}" name="survey_by_id" id="survey_by_id">
                                @foreach($survey_bies as $id => $survey_by)
                                    <option value="{{ $id }}" {{ ($task->survey_by ? $task->survey_by->id : old('survey_by_id')) == $id ? 'selected' : '' }}>{{ $survey_by }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-3"><div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('dwg_by') ? 'is-invalid' : '' }}" name="dwg_by_id" id="dwg_by_id">
                                @foreach($dwg_bies as $id => $dwg_by)
                                    <option value="{{ $id }}" {{ ($task->dwg_by ? $task->dwg_by->id : old('dwg_by_id')) == $id ? 'selected' : '' }}>{{ $dwg_by }}</option>
                                @endforeach
                            </select>
