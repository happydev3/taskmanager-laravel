...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-resurveyByTasks">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.task.fields.address') }}
                        </th>
                        <th>
                        ...
                        <th>
                            {{ trans('cruds.task.fields.resurvey_by') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-resurveyByTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
