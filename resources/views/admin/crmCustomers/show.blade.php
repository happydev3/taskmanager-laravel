...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#applicant_tasks" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="applicant_tasks">
            @includeIf('admin.crmCustomers.relationships.applicantTasks', ['tasks' => $crmCustomer->applicantTasks])
        </div>
    </div>
</div>
