...
class CrmCustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('client_code', function ($row) {
                return $row->client_code ? $row->client_code : "";
            });
        ...
        $crm_statuses = CrmStatus::get()->pluck('name')->toArray();

        return view('admin.crmCustomers.index', compact('crm_statuses'));
    }
    ...
    public function show(CrmCustomer $crmCustomer)
    {
        ...
        $crmCustomer->load('status', 'customerCrmNotes', 'customerCrmDocuments', 'applicantTasks');
