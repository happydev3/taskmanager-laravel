...
Route::group(['prefix' => 'v1', 'as' => 'api.', 'namespace' => 'Api\V1\Admin', 'middleware' => ['auth:api']], function () {
    ...
    // Tas Types
    Route::apiResource('tas-types', 'TasTypesApiController');

    // Task Cities
    Route::apiResource('task-cities', 'TaskCityApiController');

    // Task Subdivisions
    Route::apiResource('task-subdivisions', 'TaskSubdivisionApiController');
